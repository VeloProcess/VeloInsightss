...
export const useGoogleSheetsRedirect = () => {
  ...
  useEffect(() => {
    ...
    // Verificar também no hash da URL (para response_type=token)
  ...
  // Função para fazer login com redirecionamento
  const signIn = useCallback(async () => {
    ...
    try {
      ...
      const responseType = 'token' // Usar token em vez de code
